...
UUpdatePlayerLocation::UUpdatePlayerLocation()
{
	...
	// Set up key filters
	PlayerLocationKey.AddVectorFilter(this, GET_MEMBER_NAME_CHECKED(UUpdatePlayerLocation, PlayerLocationKey));
	PlayerActorKey.AddObjectFilter(this, GET_MEMBER_NAME_CHECKED(UUpdatePlayerLocation, PlayerActorKey), AActor::StaticClass());

}

void UUpdatePlayerLocation::InitializeFromAsset(UBehaviorTree& Asset)
{
